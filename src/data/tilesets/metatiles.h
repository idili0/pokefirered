...
const u16 gMetatiles_PorytilesManaged_GeneralSeaBlue[] = INCBIN_U16("data/tilesets/primary/general_sea_blue/porytiles_bin/metatiles.bin");
const u32 gMetatileAttributes_PorytilesManaged_GeneralSeaBlue[] = INCBIN_U32("data/tilesets/primary/general_sea_blue/porytiles_bin/metatile_attributes.bin");
